...
export const EVENT_NAMES = [
  ...
  'grow_unlocked',
  'grow_viewed',
  'grow_mission_started',
  'grow_mission_completed',
  'daily_quest_completed',
  'side_quest_completed',
  'customer_logged',
  'customer_3_reached',
  'customer_5_reached',
  'review_request_logged',
  'referral_system_created',
  'customer_source_recorded',
  'grow_system_equipped',
